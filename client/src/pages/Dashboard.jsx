      ...
      >
        ...
        <div className="bg-base-100 rounded-lg p-6 shadow-lg">
          <div className="flex items-center mb-4">
            <div className="w-16 h-16 rounded-full bg-primary-500 flex items-center justify-center text-white mr-4 overflow-hidden">
              {user?.profilePicture ? (
                <img
          ...
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={timeline}>
                ...
                <Line type="monotone" dataKey="upvotes" stroke="#10b981" name="Upvotes" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
